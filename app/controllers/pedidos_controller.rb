class PedidosController < ApplicationController
  ...
  def index
    @pedidos = Pedido.all.includes(:cliente).limit(10)
    # @pedidos = Pedido.all.includes(:cliente).joins(:cliente).limit(10)
  end
  ...
  private
    ...
    def pedido_params
      params.require(:pedido).permit(:cliente_id, :valor_total, :itens)
    end
end
