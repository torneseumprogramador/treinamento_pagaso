class ClientesController < ApplicationController
  ...
  def index
    @clientes = Cliente.all.limit(10).order("id desc")
    @quantidade_de_cientes = TamanhoDoRelatorio.descobrir_o_tamanho
  end
  ...
  private
    ...
    def cliente_params
      params.require(:cliente).permit(:nome, :telefone, :endereco, :cpf, :cnpj)
    end
end
